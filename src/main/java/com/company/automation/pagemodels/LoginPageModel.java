...
public class LoginPageModel extends BasePageModel {
  ...
  public HomePageModel loginWithValidCredentials(String userName, String password) {
    ...
    getWaitDriver().waitForVisibleElement(LOGIN_BUTTON).click();
  ...
  public boolean loginWithInvalidCredentials(String userName, String password) {
    this.enterCredentials(userName, password);
    getWaitDriver().waitForVisibleElement(LOGIN_BUTTON).click();
    return getWaitDriver().waitForVisibleElement(LOGIN_ERROR).isDisplayed();
  }
  ...
  public void enterCredentials(String userName, String password) {
    getWaitDriver().waitForVisibleElement(USERNAME_INPUT).sendKeys(userName);
    getWaitDriver().waitForVisibleElement(PASSWORD_INPUT).sendKeys(password);
  }
